...
class SelectRoomItemAdapter(diffCallback: RoomItemDiffCallback, private val shouldDisplayDesc: Boolean, private val fragment:Fragment) : ListAdapter<RoomItem, SelectRoomItemAdapter.AllContactsViewHolder>(diffCallback) {
