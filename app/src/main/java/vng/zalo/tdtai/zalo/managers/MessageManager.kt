...
class MessageManagerImpl @Inject constructor(
    ...
    private fun createTextMessage(room: Room, content: String, createdTime: Long): TextMessage {
        return TextMessage(
                ...
                senderPhone = sessionManager.curUser!!.phone,
            ...
            resourceManager.isContentUri(content) -> {
                ...
                with(context.contentResolver.query(localUri, arrayOf(OpenableColumns.DISPLAY_NAME), null, null, null)) {
                    if (this != null && moveToFirst()) {
                        ...
                        Log.e(this@MessageManagerImpl.TAG, "Fail to resolve info: $content")
                    }
                }
            }
            else -> {
...
//        incProg(message, emitter)
        ...
        storage.addResourceAndGetDownloadUrl(message.url, fileStoragePath, message.type!!,
...
//    }
    ...
    override fun deleteMessageAndAttachedData(roomId: String, message: Message, onSuccess: (() -> Unit)?) {
